...
function CategoryCard({ name, icon, href, count }: {
  ...
  return (
    <Link href={href}>
      <div className="group bg-white/10 backdrop-blur-md rounded-xl p-4 border border-purple-300/20 hover:border-golden/50 transition-all duration-300 hover:scale-105 text-center">

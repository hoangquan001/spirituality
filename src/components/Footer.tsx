...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-purple-900 via-indigo-900 to-purple-800 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-purple-200 text-sm">Thần Số Học</p>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-purple-300 hover:text-golden transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/" className="text-purple-200 hover:text-golden transition-colors">Trang Chủ</Link></li>
              <li><Link href="/numerology" className="text-purple-200 hover:text-golden transition-colors">Thần Số Học</Link></li>
              <li><Link href="/dream" className="text-purple-200 hover:text-golden transition-colors">Giải Mã Giấc Mơ</Link></li>
              <li><Link href="/zodiac" className="text-purple-200 hover:text-golden transition-colors">Tử Vi 12 Cung</Link></li>
            </ul>
          </div>

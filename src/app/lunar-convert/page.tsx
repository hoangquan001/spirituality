  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-950 via-indigo-900 to-purple-900">
      ...
      <div className="relative py-20 bg-gradient-to-r from-purple-900/50 to-indigo-900/50">
        ...
        <div className="absolute top-1/2 right-1/4 text-2xl text-purple-300 animate-ping">📅</div>
      </div>
              ...
              <button
                ...
                className={`p-6 rounded-xl border transition-all duration-300 ${
                  convertType === 'solar-to-lunar'
                    ...
                    : 'bg-white/5 border-purple-300/30 text-purple-200 hover:bg-white/10'
                }`}
              >
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-purple-300/20 mb-8">
                ...
                <div className="max-w-2xl mx-auto">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                      ...
                      >
                        {[...Array(30)].map((_, i) => (
                          <option key={i} value={i + 1} className="bg-purple-900">
                            {i + 1}
                          </option>
                        ))}
                      </select>
                  ...
                  <div className="flex items-center justify-center">
                    <label className="flex items-center space-x-2 text-white">
                      <input
                        ...
                        className="w-4 h-4 text-golden bg-white/10 border-purple-300/30 rounded focus:ring-golden focus:ring-2"
                      />
            ...
            <div className="text-center mt-8">
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-golden to-yellow-300 text-purple-900 font-bold rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-300"
              >
              ...
              <div className="max-w-2xl mx-auto">
                ...
                <div className="mt-6 text-center space-x-4">
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-golden hover:bg-yellow-400 text-purple-900 font-medium rounded-lg transition-colors"
                  >
                    Chuyển đổi hôm nay
                  </button>
                </div>

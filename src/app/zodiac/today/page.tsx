...
export default function ZodiacTodayPage() {
  ...
  const generateHoroscope = (signId: string): DailyHoroscope => {
    ...
    return {
      ...
      luckyColor: ['Đỏ', 'Xanh lá', 'Vàng', 'Xanh dương', 'Tím', 'Hồng'][random(0, 5)],
  ...
  return (
    <div className="min-h-screen min-h-screen">
      {/* Header */}
      <div className="relative overflow-hidden bg-gradient-to-r from-indigo-900/20 to-purple-900/20 py-10">
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            ...
            <br />
            <span className="text-white text-3xl md:text-4xl">Hôm Nay</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-4 leading-relaxed">
            <strong className="text-golden">Khám phá vận mệnh hôm nay</strong> của 12 cung hoàng đạo
          </p>
          
          <p className="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed mb-6">
            Dự đoán chi tiết về tình yêu, sự nghiệp, sức khỏe và tài chính cho ngày {currentDate}
          </p>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {zodiacSigns.map((sign) => (
              ...
              >
                <div className={`text-3xl mb-2 bg-gradient-to-r ${sign.color} bg-clip-text text-transparent`}>
                  {sign.symbol}
                </div>
                <div className="text-white font-semibold text-sm mb-1">{sign.name}</div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/20">
              <div className="text-center">
                <div className={`text-6xl mb-4 bg-gradient-to-r ${selectedZodiac.color} bg-clip-text text-transparent`}>
                  {selectedZodiac.symbol}
                </div>
                <h2 className="text-3xl font-bold text-white mb-2">{selectedZodiac.name}</h2>
                <div className="text-gray-400 mb-4">{selectedZodiac.dates} • Nguyên tố: {selectedZodiac.element}</div>
                ...
                <div className="text-center">
                  ...
                  <div className="flex justify-center gap-2">
                    {horoscope.luckyNumbers.map((num, index) => (
                      <span key={index} className="bg-purple-500/20 text-purple-300 px-3 py-2 rounded-full font-bold">
                        {num}
                      </span>
                    ))}
                  </div>

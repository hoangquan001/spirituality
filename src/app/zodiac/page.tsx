              ...
              >
                <div className="cosmic-card rounded-2xl p-6 h-full hover:scale-105 transition-all duration-300">
                  <div className="text-center">
                    {/* Icon */}
                    <div
                      className={`w-16 h-16 bg-gradient-to-br ${sign.color}  border-3 border-[#967300] p-1 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}
                    >
                      <span className="text-2xl text-white p-1">
                        {" "}
                    ...
                    <h3 className="text-xl font-thin text-[#ffc165] mb-2">
                      {sign.name}
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="cosmic-card rounded-xl p-6 text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-orange-400 to-orange-600 shadow-2xl shadow-amber-300 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <div className="cosmic-card rounded-xl p-6 text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-200 to-blue-600 shadow-2xl shadow-blue-300 rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <FAQSection
            ...
            faqs={[
              ...
              },
              {
                ...
                answer:
                  "Không, tất cả nội dung về cung hoàng đạo đều hoàn toàn miễn phí. Bạn có thể thoải mái đọc thông tin về 12 cung hoàng đạo, tìm hiểu về tính cách và những đặc điểm thú vị mà không tốn phí. Chúng mình chia sẻ những kiến thức này với mong muốn giúp mọi người hiểu thêm về bản thân.",
              },
            ]}
          />

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/cung-hoang-dao/compatibility",
  },
  robots: {
    index: true,
    follow: true,
...
const jsonLd = {
  ...
  url: 'https://giaima-tamlinh.com/cung-hoang-dao/compatibility',
  mainEntity: {
    '@type': 'Article',
  ...
  breadcrumb: {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'Tử Vi 12 Cung',
        item: 'https://giaima-tamlinh.com/cung-hoang-dao'
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: 'Ghép Đôi Cung Hoàng Đạo',
        item: 'https://giaima-tamlinh.com/cung-hoang-dao/compatibility'
      }
    ]
  }
};

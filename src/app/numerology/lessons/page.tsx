...
const karmicLessonsData: Record<number, KarmicLesson> = {
  1: {
    ...
    solution: "Thực hành đưa ra quyết định và chịu trách nhiệm cho hành động của mình",
    affirmation: "Tôi là người lãnh đạo tự nhiên và có khả năng tạo ra sự thay đổi tích cực"
  },
  2: {
    number: 2,
    title: "Bài Học Về Hợp Tác",
    description: "Học cách làm việc hài hòa với người khác và xây dựng mối quan hệ",
  ...
  3: {
    ...
    solution: "Thực hành các hoạt động nghệ thuật và chia sẻ ý tưởng với người khác",
    affirmation: "Tôi có tài năng độc đáo và có quyền thể hiện bản thân một cách tự do"
  },
  4: {
    number: 4,
    title: "Bài Học Về Kỷ Luật",
    description: "Học cách xây dựng nền tảng vững chắc và kiên trì theo đuổi mục tiêu",
    lesson: "Phát triển sự kiên nhẫn, kỷ luật và khả năng tổ chức",
    challenge: "Khắc phục sự cứng nhắc và nỗi sợ thay đổi",
    solution: "Tạo ra kế hoạch rõ ràng nhưng vẫn linh hoạt với những điều chỉnh cần thiết",
    affirmation: "Tôi có khả năng xây dựng và duy trì những nền tảng vững chắc cho thành công"
  },
  5: {
    number: 5,
    title: "Bài Học Về Tự Do",
    description: "Học cách cân bằng giữa tự do cá nhân và trách nhiệm",
    lesson: "Phát triển sự linh hoạt, khả năng thích nghi và tinh thần phiêu lưu",
    ...
    affirmation: "Tôi có thể tận hưởng tự do trong khi vẫn hoàn thành trách nhiệm của mình"
  },
  6: {
    number: 6,
    ...
    affirmation: "Tôi có thể yêu thương và chăm sóc một cách cân bằng và lành mạnh"
  },
  7: {
    number: 7,
    ...
    affirmation: "Tôi có trí tuệ nội tâm và có thể tin tưởng vào trực giác của mình"
  },
  8: {
    number: 8,
    title: "Bài Học Về Quyền Lực",
    description: "Học cách sử dụng quyền lực và thành công một cách có trách nhiệm",
    lesson: "Phát triển khả năng lãnh đạo, quản lý và đạt được thành công vật chất",
    challenge: "Khắc phục sự tham vọng quá mức và nỗi sợ thất bại tài chính",
    solution: "Sử dụng thành công để phục vụ mục đích cao hơn và giúp đỡ người khác",
    affirmation: "Tôi có thể đạt được thành công trong khi vẫn giữ được giá trị đạo đức"
  },
  9: {
    number: 9,
    ...
    affirmation: "Tôi có khả năng tạo ra tác động tích cực đến cuộc sống của nhiều người"
  }
};
...
export default function NumerologyLessonsPage() {
  ...
  const calculateChallengeNumber = (birthDate: string, period: 'first' | 'second' | 'third' | 'fourth'): number => {
  ...
  const getChallengeDescription = (challengeNum: number): { title: string; description: string; lesson: string; advice: string } => {
    const challenges: Record<number, any> = {
      0: {
        title: "Thử Thách Của Sự Lựa Chọn",
        description: "Bạn có nhiều tài năng và khả năng, nhưng cần học cách tập trung và đưa ra lựa chọn đúng đắn.",
        lesson: "Học cách quyết định và cam kết với một hướng đi cụ thể",
        advice: "Hãy tin tưởng vào trực giác và không ngại đưa ra quyết định quan trọng"
      },
      1: {
        title: "Thử Thách Của Sự Độc Lập",
        description: "Cần phát triển sự tự tin và khả năng đứng vững trên đôi chân của mình.",
        lesson: "Học cách tự lập và không phụ thuộc quá nhiều vào người khác",
        advice: "Thực hành đưa ra quyết định độc lập và chịu trách nhiệm cho hành động của mình"
      },
      2: {
        title: "Thử Thách Của Sự Nhạy Cảm",
        description: "Cần học cách quản lý cảm xúc và không để sự nhạy cảm cản trở tiến bộ.",
        lesson: "Phát triển sự cân bằng cảm xúc và khả năng hợp tác",
        advice: "Học cách đặt ranh giới lành mạnh và không quá quan tâm đến ý kiến của người khác"
      },
      3: {
        title: "Thử Thách Của Sự Biểu Đạt",
        description: "Cần vượt qua nỗi sợ thể hiện bản thân và chia sẻ tài năng với thế giới.",
        lesson: "Phát triển khả năng giao tiếp và sáng tạo",
        advice: "Thực hành thể hiện ý tưởng và cảm xúc một cách tự tin và chân thành"
      },
      4: {
        title: "Thử Thách Của Sự Kiên Trì",
        description: "Cần học cách kiên nhẫn và xây dựng nền tảng vững chắc cho thành công.",
      ...
      5: {
        ...
        description: "Cần học cách cân bằng giữa khao khát tự do và trách nhiệm cam kết.",
        lesson: "Phát triển sự linh hoạt mà không mất đi sự ổn định",
        advice: "Tìm cách thỏa mãn nhu cầu tự do trong khi vẫn hoàn thành nghĩa vụ"
      },
      6: {
        title: "Thử Thách Của Sự Hoàn Hảo",
        description: "Cần học cách chấp nhận sự không hoàn hảo và không đặt quá nhiều áp lực lên bản thân.",
        lesson: "Phát triển sự chấp nhận và lòng trắc ẩn với bản thân",
        advice: "Học cách yêu thương bản thân và người khác mà không cần sự hoàn hảo"
      },
      7: {
        title: "Thử Thách Của Sự Tin Tưởng",
        description: "Cần học cách tin tưởng vào trực giác và không quá phân tích mọi thứ.",
      ...
      8: {
        ...
        description: "Cần học cách sử dụng quyền lực và thành công một cách có trách nhiệm.",
        lesson: "Phát triển sự cân bằng giữa thành công vật chất và giá trị tinh thần",
        advice: "Sử dụng thành công để phục vụ mục đích cao hơn và giúp đỡ người khác"
      },
      9: {
        title: "Thử Thách Của Sự Buông Bỏ",
        description: "Cần học cách buông bỏ những gì không còn phục vụ mình và mở lòng với điều mới.",
        lesson: "Phát triển sự rộng lượng và khả năng tha thứ",
        advice: "Học cách buông bỏ quá khứ và tập trung vào việc cống hiến cho tương lai"
      }
    };
      ...
      const lifeChallenges: LifeChallenge[] = [
        {
          ...
          ...getChallengeDescription(calculateChallengeNumber(birthDate, 'first'))
        },
        {
          period: "Thử thách giữa đời",
          age: "36-52 tuổi", 
          challenge: calculateChallengeNumber(birthDate, 'second'),
          ...getChallengeDescription(calculateChallengeNumber(birthDate, 'second'))
        },
        {
          period: "Thử thách cuối đời",
          age: "53+ tuổi",
          challenge: calculateChallengeNumber(birthDate, 'third'),
          ...getChallengeDescription(calculateChallengeNumber(birthDate, 'third'))
        }
      ];
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            <span className="bg-gradient-to-r from-golden via-amber-300 to-golden bg-clip-text text-transparent drop-shadow-lg">
              Bài Học Nghiệp Số Và Thử Thách Cuộc Đời
            </span>
          </h1>
          
          <div className="max-w-4xl mx-auto space-y-4">
            <p className="text-xl md:text-2xl text-gray-200 leading-relaxed font-medium">
              📖 <strong className="text-golden">Khám phá bài học tâm linh và thử thách cuộc đời</strong> qua ngày sinh và số mệnh của bạn
            </p>
            
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              ✨ Hiểu rõ <span className="text-golden font-semibold">mục đích sống, bài học nghiệp lực và cách vượt qua thử thách</span> 
              theo hệ thống thần số học Pythagoras cổ điển
            </p>
          </div>
          ...
          <nav aria-label="Breadcrumb" className="flex items-center justify-center gap-2 text-sm text-gray-400 mb-8 mt-8">
            ...
            <span className="text-gray-600">›</span>
            <span className="text-golden font-medium">Bài Học Nghiệp Số</span>
          </nav>
        </div>
      </div>
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/20">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-300 leading-relaxed max-w-3xl mx-auto">
                  <strong className="text-golden">Mục đích tâm hồn:</strong> {lessons.soulPurpose}
                </p>
              </div>
            </div>
            ...
            {activeTab === 'karmic' && (
              <div className="grid md:grid-cols-2 gap-6">
                {lessons.karmicLessons.map((lesson, index) => (
                  <div key={index} className="bg-gradient-to-br from-purple-900/20 to-gray-900/50 backdrop-blur-sm rounded-3xl p-6 border border-purple-700/20">
                    <div className="text-center mb-6">
                      <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-2xl mb-4 mx-auto">
                        <span className="text-white font-bold">{lesson.number}</span>
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 text-sm">{lesson.solution}</p>
                      </div>
                      ...
                      <div className="bg-golden/10 rounded-lg p-4 border border-golden/20">
                        ...
                        <p className="text-golden text-sm italic">"{lesson.affirmation}"</p>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            {activeTab === 'challenges' && (
              <div className="space-y-6">
                {lessons.lifeChallenges.map((challenge, index) => (
                  <div key={index} className="bg-gradient-to-br from-orange-900/20 to-gray-900/50 backdrop-blur-sm rounded-3xl p-6 border border-orange-700/20">
                    <div className="flex items-start gap-6">
                      <div className="text-center">
                        <div className="w-16 h-16 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center text-2xl mb-2">
                          <span className="text-white font-bold">{challenge.challenge}</span>
                        </div>
                        <div className="text-orange-400 font-semibold text-sm">{challenge.age}</div>
                      </div>
                      
                      <div className="flex-1">
                        <h3 className="text-xl font-bold text-white mb-2">{challenge.period}</h3>
                        <h4 className="text-orange-400 font-semibold mb-3">{challenge.title}</h4>
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-300 text-sm">{challenge.lesson}</p>
                          </div>
                          ...
                          <div>
                            ...
                            <p className="text-gray-300 text-sm">{challenge.advice}</p>
                          </div>
                        </div>
                      </div>
                    </div>
